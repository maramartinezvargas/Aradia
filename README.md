...
Aradia es una aplicación web creada con Flask que simula un pequeño juego de adivinación: la IA intenta averiguar en qué personaje está pensando el usuario haciendo preguntas cerradas (sí/no/no sé).
